...
A monorepo for the Payroll PDF Processor PWA and its test/fixture tooling. The PWA runs fully client-side, extracting payroll and pension contribution data and rendering a printable report. This repo also includes the Python/Node pipelines that generate synthetic PDF and Excel fixtures used by the test suite.
