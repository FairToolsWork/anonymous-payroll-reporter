 ...
 * @property {RegExp} pensionEmployee
 * @property {RegExp} pensionEmployer
...
export const PATTERNS = {
    ...
    pensionEmployee: /NEST\s+Corporation\s*-\s*EE\s+([\d,]+\.\d{2})/i,
    // Employer pension contribution.
    pensionEmployer: /NEST\s+Corporation\s*-\s*ER\s+([\d,]+\.\d{2})/i,
    // Tax code.
