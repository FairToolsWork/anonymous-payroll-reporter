...
const allPdfPaths = fs.existsSync(FIXTURES_DIR)
    ? fs
...
describe.skipIf(allPdfPaths.length === 0)(
    'report workflow — salary PDF fixtures',
    () => {
        beforeAll(async () => {
            ...
            cachedResult = await runReportFromFixtures({
