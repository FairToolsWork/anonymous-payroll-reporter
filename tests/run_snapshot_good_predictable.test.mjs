...
describe.skipIf(!fixturesExist)('run snapshot — good-place-predictable', () => {
    beforeAll(async () => {
    ...
    describe('3-month slice (Apr–Jun 2025)', () => {
        it('has 3 records with no holiday flags', async () => {
    ...
    describe('6-month slice (Apr–Sep 2025)', () => {
        it('has 6 records with no holiday flags', async () => {
